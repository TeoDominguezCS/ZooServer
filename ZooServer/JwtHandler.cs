...
namespace ZooServer
{
    public class JwtHandler(IConfiguration configuration, UserManager<ZooUser> userManager)
    {
        public async Task<JwtSecurityToken> GetTokenAsync(ZooUser user) =>
            new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(ZooUser user)
        {
